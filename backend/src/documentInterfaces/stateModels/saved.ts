...
export default function transform(umbrella: umbrella){
    ...
    var generateModel: generateModel = {
         ...
         realizedNativeRewards: umbrella.realizingNativeRewards,
        realizedNativeFMVRewards: umbrella.realizingNativeFMVRewards,
        realizedNativeMarketDilutionRewards: umbrella.realizingNativeMarketDilutionRewards,
        realizedNativeSupplyDepletionRewards: umbrella.realizingNativeSupplyDepletionRewards,
