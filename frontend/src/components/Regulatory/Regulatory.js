	...
	return (
        <div>
          		<div className={classes.APIWrapper}>
                    <h2>Welcome to CryptoCount's regulatory tracking serivce. View your country's block reward tax law summary with linked sources.</h2>
                    <br></br>
            ...
            <br></br>
            <a href="#Switzerland">Swizterland</a>
            <br></br>
            ...
            <div> This is a web page with arbitrary information and not legal advice. CryptoCount and its developers are not responsible for any damages incurred as a result of negligence in the upkeeping accuracy of the information displayed on this page. Consult a qualified attorney or a licensed tax specialist for the most accurate regulatory information per your jurisdiction. </div>

            <br></br><br></br>
            <div id="Argentina" class ='regWrap'>
                <h3>Argentina</h3>
                <br></br>
                <h4>Summary:</h4>
                <div class="regWrap">Bitcoins are not legal currency, since they are not issued by the
                    government monetary authority and thus are not legal tender.3 Therefore, they may be
                    considered money but not legal currency, since they are not a mandatory means of cancelling
                    debts or obligations.4 According to some experts,5 a Bitcoin may be considered a good or a thing
                    under the Civil Code,6 and transactions with Bitcoins may be governed by the rules of the sale of
                    goods under the Civil Code</div>
                    <br></br>
                <div class="regWrap">   In order to determine the net profit from mining, the cryptocurrencies obtained as compensation
                    for services provided to the network will be valued at the market price on the date the transaction
                    entered the network, expressed in national currency.12 The miner may deduct all the expenses
                    necessary to obtain, maintain and preserve the taxed profits, such as electricity, amortization of
                    equipment, and staff salaries.13</div>
                    <br></br>
                <div class="regWrap">  If a company owns computer equipment and only rents the mining power to third parties by
                    depositing the mined cryptocurrencies directly into its clients’ wallet in exchange for a fee, such
                    fee would be subject to income tax.1 </div>
                    <br></br>
                <div class="regWrap">With respect to individuals engaged in cryptocurrency mining with their own computer
                    ...
                    Argentina, such profits will be considered Argentine–source income,15 and they will be taxed as
                    income at 35 percent.16
                    </div>
                    <br></br>
                    <h4>Source:</h4>
                ...
                <h4>Summary:</h4>
                <br></br>
                <div>So far, Brazil’s tax authority has not provided any detailed instructions on the taxation
...
keep documentation proving the authenticity of these values.10
...
documentation proving the authenticity of the transactions.11
<br></br><br></br>
Under article 6,
...
each operation,18 while article 10 details the penalties applicable to a natural or legal person
...
<br></br>
                ...
                <br></br>
                <h4>Summary: </h4>
                <div>[t]he income tax treatment for cryptocurrency miners is different depending on whether
...
three years.</div>
                ...
                <br></br>
                <h4>Summary: </h4>
                <div>According to the Central Bank of Chile, virtual currencies have no specific legal recognition in
...
value added tax (VAT) and income tax.3 Under the ruling, Bitcoin and other cryptocurrencies are
...
subject to income tax.5</div>
                ...
                <br></br>
                <h4>Summary: </h4>
                <div>The National Tax and Customs Directorate (DIAN), which administers revenue laws in
Colombia, considers bitcoin and digital currencies to be assets, giving them the status for tax
purposes similar to material goods.10 It has said that mining activities are subject to income tax
on the profits received by the operators.11 The tax applies on the compensation derived from
mining either by means of obtaining new coins as a result of the transaction confirmation and
validation service or the receipt of a fee.1</div>
                <br></br>
                <h4>Source:</h4>
                <a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
                ...
                <h3 id="ElSalvador">El Salvador</h3>
                <br></br>
                <h4>Summary: </h4>
                <div></div>
                <br></br>
            ...
            <h3 id="UnitedStates">United States</h3>
                ...
                <div>The IRS has issued Notice 2014-21 which directly addresses the tax implications of crypto mining.
Under the Notice, a miner will recognize gross income upon receipt of the reward tokens in an amount 
equal to the fair market value of the coins at the time of receipt.
<br></br><br></br>
Ultimately, the reward tokens that taxpayers receive in exchange for performing mining activities is taxed as ordinary income upon receipt.
The received tokens are also subject to self-employment or payroll taxes, depending on whether the taxpayer is mining as a trade or business, 
independent contractor or an employee. A taxpayer will trigger another taxable 
event when he or she ultimately sells the reward tokens, which is subject to short-term or the 
more preferential long-term capital gain rates, depending on the holding period of the tokens.</div>
                <br></br>
                <h4>Source:</h4>
                <a href="https://freemanlaw.com/taxation-of-crypto-mining/">Freeman Law</a>
                ...
                <h4>Summary: </h4>
                <br></br>
                <div>Venezuelan regulations have not established a clear position on the way in which cryptoassets
will be taxed.10
However, tax experts consider that, under the income tax law11 and its regulations, operations
and transactions involving cryptocurrency would be taxed as capital gains, with respect to any
cryptoassets, including the petro.12
...
purposes.13</div>
            ...
            <h3 id="India">India</h3>
                ...
                <h4>Summary: </h4>
                <br></br>
                <div>According to a tax expert quoted in an industry publication, “[t]ax laws in India are applicable
irrespective of the legal status of income,” and “[e]ven if a ban is introduced, taxes would
continue to apply to crypto income and it would not stop” tax authorities.</div>
                <br></br>
                <h4>Source:</h4>
                <a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">Pending</a>
<br></br><br></br><br></br>
...
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">Pending</a>
            ...
            <h4>Summary: </h4>
                <br></br>
                <div>Currency Tokens: used as a means of payment, clearing or barter only, do not confer
...
at a rate of 25% for an individual and 23% for a corporation.
<br></br><br></br>
...
for a corporation. 15
<br></br><br></br>
In a situation where the receipt of consideration in virtual currency is not part of the main
...
foreign currency.16
<br></br><br></br>
[i]ndividual investors in virtual currencies are not liable for VAT, but anyone who engages
...
<h4>Summary: </h4>
<br></br>
<div>For income tax purposes, profits generated by selling or using virtual currency are generally
classified as miscellaneous income.1 Miscellaneous income is a part of gross income.2 The income
...
currency, the corporate tax rate is 19% to 23.4%.6 A local (resident and business) tax of 10.3% is
also imposed.7
<br></br>
...
<h4>Summary: </h4>
<br></br>
<div>A miner’s profits from the disposal of the rewarded payment tokens received through
...
A company engaging in mining activities will be taxed on profits from the sale of mined
...
mining expenses are deductible.4
...
Income Tax Guide explains that this is because while the miner is entitled to a right to own a
...
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
            ...
            <br></br><br></br><br></br>
            <h3 id="UAE">United Arab Emirates</h3>
<h4>Summary: </h4>
<br></br>
<div></div>
<h4>Source: </h4>
...
<h4>Summary: </h4>
<br></br>
<div>(i) A cryptocurrency can be acquired through so called “mining”. Mining is conducted by
...
<h4>Summary: </h4>
<br></br>
<div>A. Tax Treatment of Mined and Staked Cryptocurrencies
The Danish Tax Authority (Skatteforvaltningen) has issued guidance for the tax treatment of
mined cryptocurrencies. The guidance treats mining as a hobby.10 When carried out on a large
scale over an extended period, mining is considered a commercial activity.11 The Income Tax Act
provides that a person must report and pay income tax on proceeds from hobbies.12 Financial
losses incurred as part of a hobby (a.k.a. non-commercial) activity are not deductible.13 Costs
associated with the procurement of income from hobbies are typically not deductible.14 Costs
incurred in mining on a commercial scale, such as the cost of electricity and of the mining
computer, are deductible.1
<br></br>
Cryptocurrency tokens are treated as investment property and capital gains are taxed upon their
sale.22 The taxation of each cryptocurrency is determined individually, using the first in first out
(FIFO) principle to determine the cost basis.23 For tokens that have no purchase value, the fair
market value at the time of mining will apply.24 Depending on how they were acquired,
cryptocurrencies received as gifts may not be subject to tax upon realization.2</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h4>Summary: </h4>
<br></br>
<div>Specifically, cryptocurrencies are
...
for currency gains of less than €500 (about US$610).6
<br></br>
s
Finland taxes cryptocurrencies both at the acquisition stage and at the realization stage
<br></br>
...
miner’s old virtual currency remains unchanged
<br></br>
...
<h4>Summary: </h4>
<br></br>
<div>A. Non-professionals
Since January 1, 2018, the global value added of all taxable operations realized by nonprofessional cryptocurrency investors during the year is subject to a flat tax of 30%.11 The sale of
cryptocurrency for euros or other legal currencies is the operation that generates the obligation
to pay the tax.12 Cryptocurrency owners who hold onto their crypto-assets without converting
them into fiat currency therefore do not have to pay taxes.1
<br></br>

Cryptocurrency miners are taxed differently according to whether their revenue is above or
below 70,000 euros (approximately US$85,000).14 If their revenue for a given year is no more than
70,000 euros, they are simply taxed according to the income tax scale, but after a flat 34%
abatement.15 For example, if a miner receives 50,000 euros in a cryptocurrency for his or her
mining activities, he or she will be taxed only on the basis of 33,000 euros after the abatement is
applied.16 If a cryptocurrency miner’s revenue is above 70,000 euros, he or she no longer qualifies
for the flat abatement and must instead itemize deductions.17 Furthermore, he or she is not taxed
...
miner receives it.19 However, if the cryptocurrency is not immediately converted into fiat
currency, any value added may be taxed later when it is converted.20
...
French income tax scale for the remainder.21 Traders whose total revenues exceed 170,000 euros
are taxed according to the corporate tax scale, after itemized deductions instead of the flat
abatement.22 It appears that, for purposes of taxing professional traders, cryptocurrencies are
valuated when they are traded for official currency.23
</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h3 id="Gremany">Germany</h3>
<h4>Summary: </h4>
<br></br>
<div>With regard to mining, the federal ministry of finance in its 2018 guidance held that bitcoin
mining is a nontaxable transaction.12 It noted that miners fulfill a service that is central to
maintaining the bitcoin system. They make their processing power available to a mining pool, record transactions in a “block,” and subsequently add it to a “blockchain.” The ministry of
...
(Einkommenssteuergesetz, EStG).14 A person operates a business if the activity is performed with
the aim of making a profit, is sustainable, there is participation in economic transactions, and the
work is performed independently.1</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h4>Summary: </h4>
<br></br>
<div>There are no taxation laws or rules that specifically apply to the mining of cryptoassets in Ireland.
If virtual currencies are mined, any virtual assets acquired as a result of mining may be subject to
capital gains tax.19 The only guidance from the Office of the Revenue Commissioners on mining,
...
<h4>Summary: </h4>
<br></br>
<div>A. Virtual Currencies (Cryptoassets) as Foreign Fiat Currencies
For tax purposes, Italy considers virtual currencies (cryptoassets) as foreign fiat currencies.13 Italy
is among the few countries that “do not consider any exchanges made by individuals to be a
taxable event for the holder of the virtual currency,”14 unless they are considered to be
speculative,15 as will be explained below.
<br></br>
With respect to personal income tax, “the profits generated by the trading of crypto assets are
regarded as those deriving from FOREX [foreign exchange] trading for personal tax purposes.”17
...
between virtual currencies and fiat currencies.”20
As a result, in Italy the disposal of the token for goods and services does not give rise to a taxable
event for the owner of the virtual currency,21 as this country does “not consider any disposals to
be a taxable event in relation to the token.”22
<br></br>
C. VAT Treatment of Virtual Currencies in Italy
In Italy, the exchange of virtual currencies is not subject to VAT,23 whether the exchange “is made
for fiat currency or other virtual currencies.”24 The use of virtual currencies to acquire goods or
services is also outside the scope of VAT.25 However, the receipt of new tokens via mining is
subject to the VAT.26</div>
<br></br>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h4>Summary: </h4>
<br></br>
<div>The Norwegian Tax Authority (Skatteetaten) has issued guidance for the tax treatment of mining
of cryptocurrencies. The Tax Authority typically treats mining as a hobby, the income from which
is not taxed
<br></br>
Hobbies are not taxed, while
commercial activity is.9 Whether mining constitutes a commercial activity will depend on its
scope and duration.10 According to the Tax Authority, staked cryptocurrencies are treated as
mined cryptocurrencies for purposes of income taxation.11 Holders must report their proof of
work and proof of stake protocols on their tax return
<br></br>
Persons must report proceeds from hobbies as well as from commercial activity.13 Income from
hobby activity, such as mined virtual currencies, is reported as “other income.”14 Conversely,
...
respect to virtual currency income and losses.16 The value to be included for mined and staked
currencies is the fair market value at the time of the mining.17 Costs incurred in mining or staking
...
the cryptocurrency was acquired. All sales are taxable events.22 Taxes are paid on the amount the
sales price exceeds the cost for acquiring the asset, i.e. the capital gain.23 Typically, the value of
...
Norwegian, or at market value at the time of receipt if the giver is not Norwegian.24 If the value
of the cryptocurrency at acquisition is not known, the value will be set to zero and the entire
amount the cryptocurrency is sold for will be considered taxable and subject to capital gains tax.25</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
• [T]he organization of issuance of digital currency utilizing domain names and network
...
as parts of Russian informational infrastructure.)1
<br></br>
• [T]he issuance of digital currency is an activity involving Russian information
infrastructure and /or user equipment located in Russia aimed at enabling the use of
digital currency by third parties.15
• Arranging circulation of the digital currency is a provision of services with the purpose
...
year.18 Enforcement of this provision began on August 26, 2020, when Russia’s government
blocked the country’s top crypto exchange aggregator.19
<br></br>
...
transactions with digital currency, and on digital currency balances.25
Article 38 states that cryptocurrency shall be treated as “assets” subject to a mandatory
declaration to the Russian tax authorities.2</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h4>Summary: </h4>
<br></br>
<div>Taxation of staking has not been specifically regulated. Therefore, according to tax professionals,
staking should be evaluated in relation to similar services whose tax treatment has already been
clearly defined by the tax authority.9</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
<h4>Summary: </h4>
<br></br>
<div>For tax purposes, at the time of
sale, cryptoassets are considered “other assets” as regulated in chapter 52 of the Income Tax Act,3
which provides that the profit made at the time of sale should be taxed, similarly to capital gains.4
Mining of cryptocurrencies qualifies as income from a hobby unless done on a commercial scale.5
The Supreme Administrative Court (Högsta förvaltningsdomstolen) has established that any
profits made when selling Bitcoins is subject to taxation as capital gains.6 
<br></br>
The Swedish Tax Authority specifically
...
<br></br>
Native tokens are defined as “digital
...
a service vis-à-vis the investor.”2 Asset tokens represent “monetary claims against the issuer or
...
investor.4 Utility tokens that are issued within the framework of an ICO or an ITO are those that
provide investors with the right to use digital services on a (decentralized) platform service
generally by means of a blockchain-based infrastructure.5 As with asset-backed tokens, their tax
treatment depends on the civil law relationship between the issuer and investor.6
<br></br>
...
<br></br>
Native tokens are intangible assets and therefore subject to wealth tax.10 In Switzerland, the
individual cantons, the Swiss states, are obligated to levy income tax and wealth tax on the total
property (assets and rights with a cash value) of taxpayers that are resident in their canton.11
Property is assessed at market value at the end of the tax period.12 Tax rates vary between the
...
31st of the fiscal year
<br></br>
Block rewards received for mining do not qualify as compensation as defined in the VAT Act,
because there is no exchange of services.17 If validating blockchain transactions is only
...
for a beneficiary located within the tax territory.19 A block reward that is generated in addition to
the transaction fee has no influence on the input tax deduction.20
<br></br>
...
<h4>Summary: </h4>
<br></br>
<div>initially form part of trading stock. If these cryptoassets are transferred out of trading stock,
...
the cryptoasset was taken out of trading stock.
<br></br>
...
income,14 and the individual will have to complete a self-assessment tax return unless the
cryptoassets are worth less than £1,000 (approximately US$1,400) or the individual has received
less than £2,500 (approximately US$3,300) from other untaxed income
<br></br>
In cases where individuals mining cryptoassets decide to keep any they have mined, capital gains
tax may later become payable when the asset is disposed of.17 Disposal of cryptoassets may occur
...
any capital gains tax due will be reduced by the amount of income tax.1
<br></br>
HMRC has noted that individuals holding cryptoassets as a personal investment will be liable to
pay capital gains tax when the assets are disposed of. 
<br></br>
...
Tax will take priority over Capital Gains Tax.</div>
<h4>Source: </h4>
<a href="https://www.loc.gov/item/2021666100/?loclr=bloglaw">U.S. Library of Congress</a>
...
months or more, you may be entitled to
<br></br>
Where a person mines cryptocurrency as a hobby, mined coins do not need to be reported as income;
taxes are only payable upon their disposal (i.e., a CGT event).Business miners, however, must
report the fair market value of the tokens received at the time of receipt, and may deduct miningrelated business expenses, such as equipment and electricity.
<br></br>
tax treatment of block rewards
...
equal to the money value of the tokens they receive.19
<br></br>
...
<br></br>
<div>
people can buy, sell, and exchange cryptoassets; provide goods or services in
...
make from selling, trading or exchanging crypto-assets is taxable.5
<br></br>
[i]n most cases, cryptoassets you get from mining (such as transaction fees and block
