...
const Analysis = (props) => {
	...
	const handleDownload = (e) => {
		...
		var object = [{"QUANTITY OF REWARDS SOLD:" : set["data"]["realizingRewardAgg"].toFixed(2)},
		{"PERIOD START: ": set["data"]["realizingRewards"][0]["date"]},
		{"PERIOD END: ": set["data"]["basisPrice"].toFixed(2) + " " + set["data"]["fiat"]},
		{"TRUE REWARD INCOME: ": numberWithCommas(currentSet["incomeToReport"].toFixed(2)) + " " + set["data"]["fiat"]},
		{"AVERAGE BASIS COST: ": set["data"]["basisPrice"].toFixed(2) + " " + set["data"]["fiat"]}
		]
		doc.table(25, 88, object)
