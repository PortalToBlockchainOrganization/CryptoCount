...
const Privacy = () => {
	return (
        ...
        <li>Last updated: September 16, 2021</li>
        ...
        <ul>
          ...
          <li>
            <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Crypto Count</li>
          </li>
          <li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Portal To Blockchain Organization, 1395 Kelton Avenue, Los Angeles, CA, 90024.</li>
          </li>
          <li>
          ...
          <li>
            <li><strong>Website</strong> refers to Crypto Count, accessible from <a href="cryptocount.co" rel="external nofollow noopener">cryptocount.co</a></li>
          </li>
          <li>
        ...
        <li>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</li>
        <ul>
        ...
        <li>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</li>
        <h3>Law enforcement</h3>
        <li>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</li>
        ...
        <li>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</li>
        ...
        <h1>Contact Us</h1>
        <li>If you have any questions about this Privacy Policy, You can contact us:</li>
        <ul>
