...
const Privacy = () => {
	return (
        ...
        <ul>
          ...
          <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Crypto Count</p>
          </li>
          <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Portal To Blockchain Organization, 1395 Kelton Avenue, Los Angeles, CA, 90024.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Crypto Count, accessible from <a href="cryptocount.co" rel="external nofollow noopener">cryptocount.co</a></p>
          </li>
          <li>
