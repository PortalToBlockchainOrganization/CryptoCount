...
router.delete("/:setId", function (req, res) {
    ...
    async.waterfall([
        ...
        function (docs, cb) {
            ...
            User.findOneAndUpdate({ _id: ssn.prsId }, { $pull: { setIds: setId } }, function (err, doc) {
                if (err)
                    cb(err);
                cb(null, doc);
            });
        ...
        function (set) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (lastModifiedDate < twoDaysAgo) {
                    try {
                        var updatedSet = yield updateSet(set);
                        return updatedSet;
                    }
                    catch (error) {
                        return error;
...
router.post("/Auto", function (req, res) {
    ...
    async.waterfall([
        ...
        function (address_check) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    unrel_obj = yield autoAnalysis(address, fiat);
                    return unrel_obj;
                }
                catch (error) {
                    return error;
        ...
        function (rel_doc, cb) {
            ...
            if (rel_doc) {
                User.findOneAndUpdate({ _id: prsId }, { $addToSet: { setIds: rel_doc._id } }, function (err, doc) {
                    if (err)
                        cb(err);
                    cb(null, rel_doc);
                });
...
router.post("/Realize", function (req, res) {
    ...
    async.waterfall([
        function (cb) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    rel_obj = yield realizeRew(body["realizedQuantity"], body["setId"]);
                    return rel_obj;
                }
                catch (error) {
                    return error;
...
router.post("/Unrel", function (req, res) {
    ...
    async.waterfall([
        function (cb) {
            return __awaiter(this, void 0, void 0, function* () {
                if (vld.hasFields(body, [
                    ...
                    try {
                        unrel_obj = yield analysis(address, basisDate, fiat);
                        return unrel_obj;
                    }
                    catch (error) {
        ...
        function (unrel_obj, cb) {
            ...
            RealizeHistObj.findOneAndUpdate({ _id: body["histObjId"] }, {
                $set: {
                    userid: prsId,
                    version: 0,
                    fiat: body["fiat"],
...
router.post("/Cal", function (req, res) {
    ...
    async.waterfall([
        function (cb) {
            return __awaiter(this, void 0, void 0, function* () {
                if (vld.hasFields(body, ["address", "fiat"]))
                    prices = yield getPrices(body["fiat"]);
                cal_vals = yield getBalances(body["address"], prices);
...
function getBalances(address, price) {
    return __awaiter(this, void 0, void 0, function* () {
        let balances = {};
        //offset from index
        let offset = 0;
